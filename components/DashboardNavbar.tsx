...
export default function DashboardNavbar() {
  ...
  return (
    <div className="w-11/12 h-[13%] md:h-1/6 mx-auto flex items-center justify-between md:justify-end">
      <div className="md:hidden ml-5 w-52 flex items-center gap-4">
        <Sheet>
          <SheetTrigger>
            <Button
              size={"icon"}
      ...
      <div className="w-[200px] md:w-[400px] flex items-center justify-end mr-5 gap-5">
        <Button
          size={"icon"}
          variant={"ghost"}
          className="md:hidden ml-5 bg-zinc-50 dark:bg-zinc-700 rounded-full">
        ...
        <Popover>
          ...
          <PopoverContent className="w-64 mt-3 mr-5 text-center border-2 dark:bg-zinc-950 dark:border-black">
            <div className="cursor-pointer pb-3 pl-2 w-full flex items-center justify-between text-zinc-600 hover:text-zinc-900 dark:text-white">
              <DropdownMenu>
                <DropdownMenuTrigger
                  asChild
            ...
            <div className="cursor-pointer py-3 pl-2 border-t border-zinc-200 dark:border-zinc-800 flex items-center gap-3 text-zinc-600 hover:text-zinc-900 dark:text-white">
